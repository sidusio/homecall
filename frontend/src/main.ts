...
import { faChevronDown, faChevronUp, faChevronRight, faPlus, faGear, faPen, faTrash, faEnvelope, faCheck, faExclamationTriangle, faPhone, faTabletScreenButton } from '@fortawesome/free-solid-svg-icons'

/* add icons to the library */
library.add([faGear, faPlus, faChevronRight, faChevronUp, faChevronDown, faPen, faTrash, faEnvelope, faCheck, faExclamationTriangle, faPhone, faTabletScreenButton])
